    ...
    var alertNote = (function () {
        ...
        var alertNote = function (msg, hideDelay, options) {
            ...
            if (unobtrusive) {
                try {
                    var firstChild: any = div.firstChild.firstChild.firstChild;
        ...
        (alertNote as any).hide = function () {
            h(div);
            clearTimeout();
        };
    ...
    */
    ...
    var getCurrentExecutionDetails = function (options) {
        ...
        var stackToReport: any = errStr.split(/\n/);
    ...
    export class ConsolePanel {
        ...
        hideBecauseDevToolsIsOpen = function () {
            var that = this;
        ...
        getRecommendedClassNameForDevToolsIcon = function () {
        ...
        areThereUnreadRelevantMessages = function (relevantMessages) {
            var arrLogs = this.arrLogs;
                ...
                if (logEntry.length === 0) {
                    ...
                    for (var i = 0; i < logEntry.length; i++) {
                        ...
                        var updateDom = function (options) {
                            ...
                            var JSONEditor = JSONEditor || undefined;
        ...
        logArrayEntry = function (options) {
        ...
        markLogEntry = function (logMode, args) {
            var entryToPush = [];
        ...
        setupIntercept = function () {
            ...
            originals['window.onerror'] = interceptIfRequired('window.onerror', originals['window.onerror'], function () { return after(window,     'onerror', function () { that.markLogEntry('window.onerror', [{ error: arguments }]); }, undefined); });
        ...
        render = function () {
            ...
            devTools.style.height = (function () {
                var height = parseInt(userPreference('consolePanelHeight', undefined), 10);
            ...
            window.addEventListener('console-panel-devtoolschange', function (e: CustomEvent) {
        ...
        */
        ...
        enableReportLogLines = function () {
            this.config.reportLogLines = true;
        };
        disableReportLogLines = function () {
