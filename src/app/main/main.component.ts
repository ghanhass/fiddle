...
export class MainComponent implements AfterViewInit {
  ...
  stretchVertically() {
    if (this.layout == 1 || this.layout == 3) {
      this.emptyArea_1_Size = 0;
      this.emptyArea_2_Size = 0;
      this.mainService.iframeResizeValue = this.mainContainerHeight - 5 - 5;

      this.iframeHeight = this.mainContainerHeight - 5 - 5;
    }
    else {
      this.finalCodePartSize = 350;
      this.mainService.codePartsSize = 350;

      this.iframeHeight = this.mainContainerHeight - 350 - 5;
    }
  ...
  stretchHorizontally() {
    if (this.layout == 1 || this.layout == 3) {
      ...
      this.iframeWidth = this.mainContainerWidth - 350 - 5;
    }
    else {
      this.emptyArea_1_Size = 0;
      this.emptyArea_2_Size = 0;
      ...
      this.iframeWidth = this.mainContainerWidth - 5 - 5;
    }
  }
